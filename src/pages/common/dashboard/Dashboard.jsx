    ...
    const fetchDashboardData = async () => {
      ...
      try {
        ...
        const [overviewResponse, activitiesResponse, financialResponse, conversionResponse, todaysMeetingsResponse, tomorrowsMeetingsResponse] = await Promise.all([
          ...
          fetchFinancialSummary(),
          fetchLeadConversionRates(),
          userId ? meetingAPI.getMyTodaysMeetings(userId).catch(err => {
            console.error('Error fetching today\'s meetings:', err);
            return { data: { data: [] } };
          }) : Promise.resolve({ data: { data: [] } }),
          userId ? meetingAPI.getMyTomorrowsMeetings(userId).catch(err => {
        ...
        console.log('Today\'s meetings response status:', todaysMeetingsResponse.status);
        console.log('Tomorrow\'s meetings response status:', tomorrowsMeetingsResponse.status);
        
        if (todaysMeetingsResponse.data?.data) {
          console.log('Setting today\'s meetings:', todaysMeetingsResponse.data.data);
          console.log('Today\'s meetings count:', todaysMeetingsResponse.data.data.length);
          setTodaysMeetings(todaysMeetingsResponse.data.data);
        } else {
          console.log('No today\'s meetings data found');
          console.log('Today\'s meetings response structure:', JSON.stringify(todaysMeetingsResponse, null, 2));
          setTodaysMeetings([]);
        }
        
        if (tomorrowsMeetingsResponse.data?.data) {
          console.log('Setting tomorrow\'s meetings:', tomorrowsMeetingsResponse.data.data);
          console.log('Tomorrow\'s meetings count:', tomorrowsMeetingsResponse.data.data.length);
          setTomorrowsMeetings(tomorrowsMeetingsResponse.data.data);
        } else {
          console.log('No tomorrow\'s meetings data found');
          console.log('Tomorrow\'s meetings response structure:', JSON.stringify(tomorrowsMeetingsResponse, null, 2));
          setTomorrowsMeetings([]);
        }

        // Debug role-wise customers data
        if (overviewResponse.statusCode === 200) {
          console.log('Role-wise customers data:', overviewResponse.data.roleWiseCustomers);
          console.log('Type of roleWiseCustomers:', typeof overviewResponse.data.roleWiseCustomers);
          console.log('Keys in roleWiseCustomers:', Object.keys(overviewResponse.data.roleWiseCustomers || {}));
        }
    ...
    <Box bg={bgColor} minH="100vh" p={6}>
      ...
      {/* Statistics Grid */}
        ...
        />
          ...
          >
            <Grid templateColumns={{ base: 'repeat(3, 300px)', md: 'repeat(3, 350px)', lg: 'repeat(3, 400px)' }} gap={6} minW="fit-content">
            <GridItem>
                ...
                >
                  <CardBody p={6}>
                    ...
                    <VStack spacing={2} align="stretch" maxH="300px" overflowY="auto">
                      {console.log('Rendering today\'s meetings:', todaysMeetings)}
              ...
              <motion.div variants={itemVariants}>
                ...
                >
                  <CardBody p={6}>
                    ...
                    <VStack spacing={2} align="stretch" maxH="300px" overflowY="auto">
                      {console.log('Rendering tomorrow\'s meetings:', tomorrowsMeetings)}
