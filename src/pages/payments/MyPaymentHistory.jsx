...
const MyPaymentHistory = () => {
  ...
  const fetchMyPayments = async () => {
    try {
      ...
      toast({
        title: "Error",
        description: "Failed to fetch my payment history",
        status: "error",
        duration: 3000,
        isClosable: true,
        position: "top-right",
  ...
  const handleExport = async (format) => {
    try {
      ...
      const exportData = filteredPayments.map(payment => ({
        ...
        'Last Updated': formatDate(payment.updatedAt || payment.lastUpdated)
      }));
      ...
      a.href = url;
      a.download = `my_payment_history_${new Date().toISOString().split('T')[0]}.csv`;
      ...
      toast({
        ...
        description: `My payment history exported as ${format.toUpperCase()}`,
        status: "success",
        duration: 3000,
        isClosable: true,
        position: "top-right",
      ...
      toast({
        title: "Export failed",
        description: "Failed to export my payment history",
        status: "error",
        duration: 3000,
        isClosable: true,
        position: "top-right",
  ...
  return (
    <Box p={{ base: 3, md: 6 }} bg="gray.50" minH="100vh">
      ...
      <SearchAndFilter
        ...
        searchPlaceholder="Search my payments..."
        filters={{ 
          status: statusFilter, 
